      ...
      <main className="max-w-6xl mx-auto px-4 py-6">
        ...
        {folder.topics.length === 0 ? (
          <div className="text-center py-12 text-slate-400">
            ...
            <p className="text-sm mt-1">Asigna temas a esta carpeta desde el dashboard</p>
          </div>
        ) : (
  ...
  if (results.length === 0) {
    return (
      <div className={cn(
        ...
        <p className="text-slate-500">Sin resultados para "{query}"</p>
      </div>
    );
  }
  ...
  return (
    ...
    >
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1 min-w-0">
          <h3 className="font-semibold text-slate-800 dark:text-white truncate group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors">
            {topic.name}
          </h3>
